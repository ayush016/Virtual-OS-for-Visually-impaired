 ...
 * 
 */
@WebServlet("/Voice_Add_Contact")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, 	// 2MB
				maxFileSize = 1024 * 1024 * 10, 		// 10MB
				maxRequestSize = 1024 * 1024 * 50)		// 50MB
public class Voice_Add_Contact extends HttpServlet {
	private String host;
	private String port;
	private String user;
	private String pass;
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			getServletContext().getRequestDispatcher("/index_backup.jsp").forward(
					request, response);
		}
	}
