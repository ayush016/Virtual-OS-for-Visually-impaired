 ...
 * @author rajat
 */
@WebServlet(urlPatterns = {"/add_memo"})
...
Class.forName("com.mysql.jdbc.Driver");
      ...
      out.write("        <div class=\"ui huge header\">New Memo</div>\n");
      out.write("        <form class=\"ui form\" action=\"add_memo\" method=\"POST\" >\n");
      out.write("            <div class=\"field\">\n");
      out.write("                <label>Title</label>\n");
      out.write("                <input type=\"text\" name=\"sub\" value=\"\" />\n");
      out.write("            </div>\n");
      out.write("            <div class=\"field\">\n");
      out.write("                <label>Post Content</label>\n");
      out.write("                <textarea name=\"cont\" ></textarea>\n");
      out.write("            </div>\n");
      out.write("            <button class=\"ui big violet basic button\" type=\"submit\" name=\"SUBMIT\" >Create Note</button>\n");
      out.write("            <button class=\"ui big violet basic button\" type=\"reset\" name=\"RESET\" >Reset</button>\n");
      out.write("        </form>\n");
      out.write("    </div>\n");
      out.write("        </form>\n");
      ...
      out.write("            ");
            ...
            MemoOb x=new MemoOb(sub,text);
            MEMO add=new MEMO();
            result=add.setMemo(x);
            }
