   	...
   	<head>
        ...
        <script>
			...
			function changeColor()
			{
                ...
                <script>
/*
var val = sessionStorage.getItem("secure");
 if(val!=="1")
 {
		...
		<div class="container">	
			<div id="bl-main" class="bl-main">
				...
				<section id="bl-work-section">
                	<a href="Sudoku.html">
					<div class="bl-box">						
                    	<h2><img src="sudoku.png" width="96" height="96" alt="ic_stat_access_alarms"/><br>SUDOKU</h2>
					</div>
					</a>
				</section>
				<section id="two">
                ...
                <section style="border-radius:50%;height:130px;width:130px;top:39%;left:45.4%;">
                	<div class="bl-box" >
                    	<a href="mainnew.jsp"><img id="microphone" src="microphone1.png" width="100%" height="100%" /></a>
